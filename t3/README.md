...
- Dată fiind aplicația `app` completați metoda `POST` la adresa `/food-items` astfel încât:
    ...
    - Dacă elementul adăugat are o categorie invalidă, se va returna un json cu următorul format: `{"message": "not a valid category"}`. Codul de răspuns va fi: `400`. (0.5 pts)
...
9. Copiază link-ul repository-ului și completează [acest formular](https://forms.gle/hpGYBZrmTzBg1FFm7)
